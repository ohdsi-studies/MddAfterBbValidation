...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "MddAfterBbVal")
...
.createCohorts <- function(connection,
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "MddAfterBbVal")
  if(pathToCustom!=""){
