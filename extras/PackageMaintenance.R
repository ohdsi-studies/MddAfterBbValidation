...
#
# This file is part of MddAfterBbValidation
#
...
OhdsiRTools::checkUsagePackage("MddAfterBbValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/MddAfterBbValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/MddAfterBbValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "MddAfterBbValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("MddAfterBbValidation")
