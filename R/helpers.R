...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "depressionValidation")
...
.createCohorts <- function(connection,
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "depressionValidation")
  if(pathToCustom!=""){
