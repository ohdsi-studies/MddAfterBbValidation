...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "MddAfterBbValidation")
...
.createCohorts <- function(connection,
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "MddAfterBbValidation")
  if(pathToCustom!=""){
